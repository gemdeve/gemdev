...
<body>
	...
	<section id="main">
		<div class="contain">
		<h1> List Account</h1>
		<p><a href = "account_add.php">Add New Account</a></p>
		<?php 
			require_once("databases/Database.php");
			require_once("databases/users.php");
			$db = new users();
			
			$listaccount = $db->select_all();
		?>	
		...
		foreach ($listaccount as $account) {
			...
			echo "<td>", $account["activated"], "</td>";
	
			echo "<td>";
			echo "<a href='account_update.php?id=" . $account['id']."'>Update</a><br>";
			echo "<a href='account_delete.php?id=" . $account['id']."'>Delete   </a>";
			echo "</td>";
			echo "</tr>";
		}
		?>
