<?php 	
		...
		$retrieveproject= query("SELECT * from project where email = (SELECT email FROM users WHERE username ='$username')");
...
<section id="main">
	<div class="contain">
		...
		<?php
		foreach ($retrieveproject as $project) {
			echo "<tr>";
			...
			echo "<td>";
			echo "<a href='project_delete_user.php?id=" . $project['id_project']."'>Delete  </a><br>";
			echo "<a href='project_view.php?id=" . $project['id_project']."'>View  </a><br>";
			echo "<a href='edit_project.php?id=" . $project['id_project']."'>Edit  </a> ";
			echo "</td>";
			echo "</tr>";
		}
		?>
